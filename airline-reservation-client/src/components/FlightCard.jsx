...
function hasDeparted(departureStr) {
  return new Date(departureStr) <= new Date();
}
...
export default function FlightCard({ flight }) {
  ...
  const departed = hasDeparted(flight.departureTime);

  return (
    <div
      className={`boarding-pass ${departed ? "boarding-pass-departed" : ""}`}
      onClick={() => !departed && navigate(`/flights/${flight.id}`)}
      style={{ cursor: departed ? "not-allowed" : "pointer" }}
    >
      <div className="boarding-pass-main">
        ...
        <div className="flight-route-row">
          <div className="flight-route-point">
            ...
            <div className="text-muted flight-route-date">
          ...
          <div className="flight-route-point flight-route-point-end">
            <span className="flight-route-time-value">
              ...
              {overnight && (
                <span className="badge badge-amber flight-plusday">+1</span>
              )}
            </span>
            <div className="text-muted flight-route-city">
              {flight.destination}
            </div>
            <div className="text-muted flight-route-date">
